...
<body>
	...
	<section id="other-home">
        <img id="other-home-bg-image" src="<?php echo asset('assets/tmp-img/home/Careers.png');?>">
			<div id="other-home-content-inner" class="text-center">
				...
				<div id="other-home-text">
					<p><a href="index.html"><img src="<?php echo asset('assets/tmp-img/Icons/home.png');?>" alt="home">Home</a> <img src="<?php echo asset('assets/tmp-img/Icons/arrow.png');?>" alt="arrow">Careers</p>
				</div>
			</div>
	</section>
	<!-- Home Ends -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7  wow slideInDown">
                        ...
                        <div class="horizontal-heading">
                            <h5>Be part of a small team</h5>
                            <h2>That Makes A <span>Huge Difference</span> </h2>
                    ...
                    <div class="col-md-5 col-sm-5 wow slideInRight">
                        <img src="<?php echo asset('assets/tmp-img/services/sub-career.png');?>" alt="client" class="img-responsive">
                    </div>
                </div>
