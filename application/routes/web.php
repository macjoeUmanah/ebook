...
Route::get('careers', 'AuthController@careers');
Route::get('pricing', 'AuthController@pricing');
Route::get('about', 'AuthController@about');
Route::get('what', 'AuthController@what');
Route::get('terms', 'AuthController@terms');
Route::get('policy', 'AuthController@policy');
